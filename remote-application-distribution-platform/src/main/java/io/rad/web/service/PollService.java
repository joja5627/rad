...
import io.rad.web.exception.BadRequestException;
import io.rad.web.exception.ResourceNotFoundException;
import io.rad.web.model.*;
import io.rad.web.payload.PagedResponse;
import io.rad.web.payload.PollRequest;
import io.rad.web.payload.PollResponse;
import io.rad.web.payload.VoteRequest;
import io.rad.web.repository.PollRepository;
import io.rad.web.repository.UserRepository;
//import io.rad.web.repository.VoteRepository;
import io.rad.web.security.UserPrincipal;
import io.rad.web.util.AppConstants;
import io.rad.web.util.ModelMapper;
...
//        // Map Polls to PollResponses containing vote counts and poll creator details
        List<Long> pollIds = Collections.EMPTY_LIST;
    ...
    public PagedResponse<PollResponse> getPollsVotedBy(String username, UserPrincipal currentUser, int page, int size) {
        ...
        Pageable pageable = PageRequest.of(page, size, Sort.Direction.DESC, "createdAt");
        Page<Long> userVotedPollIds = null;
    ...
    public Poll createPoll(PollRequest pollRequest) {
        ...
        pollRequest.getChoices().forEach(choiceRequest -> {
            poll.getChoices().add(Choice.builder().text(choiceRequest.getText()).build());
        });
    ...
    public PollResponse getPollById(Long pollId, UserPrincipal currentUser) {
        ...
        List<ChoiceVoteCount> votes = null;
